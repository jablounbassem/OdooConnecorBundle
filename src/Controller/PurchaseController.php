...
class PurchaseController extends Controller
{
    ...
    public function listPurchaseAction()
    {
        ...
        return $this->render('OdooConnectorBundle:Purchase:list.html.twig', array(
            "purchases" => $purchases
        ));
    }
    ...
    {
        $purchaseOrderService = $this->get('PurchaseOrderService');
...
*/
    public function getPurchaseAction($id)
    {
        ...
        $purchaseService = $this->get('PurchaseOrderService');
        ...
        if (count($purchase)==0){
          return  $this->redirect($this->generateUrl('odoo_connector_purchaseOrderLists'));
            ...
            $commandeLines=$purchaseService->getPurchaseOrderCommandeLine($id);
             ...
             return $this->render("OdooConnectorBundle:Purchase:purchase.html.twig",array(
                  'purchase'=>$purchase[0],
                  'commandeLines'=>$tab
              ));
    ...
    public function updatePurchaseFormAction($id)
    {
        ...
        if (count($purchase) == 0) {
            ...
            return $this->render("OdooConnectorBundle:Purchase:update.html.twig", array(
                'purchase' => $purchase[0],
                'vendors'  =>$vendor,
                'commandeLines' => $tab,
                "articles"=>$articles,
